...
const SECTION_LABEL = { lever: '槓桿', wheel: '輪軸', pulley: '滑輪', gear: '齒輪+綜合' };
        ...
        <div className="max-w-5xl mx-auto p-4 md:p-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <nav className="flex flex-wrap gap-2 justify-center">
              ...
              <TabButton active={activeTab === 'lever'} onClick={() => tryTab('lever')} label="槓桿" />
              <TabButton active={activeTab === 'wheel'} onClick={() => tryTab('wheel')} label="輪軸" locked={!isSectionAccessible('wheel')} />
              <TabButton active={activeTab === 'pulley'} onClick={() => tryTab('pulley')} label="滑輪" locked={!isSectionAccessible('pulley')} />
              <TabButton active={activeTab === 'gear'} onClick={() => tryTab('gear')} label="齒輪+綜合" locked={!isSectionAccessible('gear')} />
...
function LeverSection() {
  ...
  return (
    <div className="animate-fade-in">
      <h2 className="text-2xl font-bold text-blue-800 mb-6 flex items-center gap-2 border-b pb-2">
        <Scale className="text-blue-500" /> 認識槓桿原理
      </h2>
...
function WheelAxleSection() {
  ...
  return (
    <div className="animate-fade-in">
      <h2 className="text-2xl font-bold text-blue-800 mb-6 flex items-center gap-2 border-b pb-2">
        <RotateCw className="text-blue-500" /> 認識輪軸
      </h2>
...
function PulleySection() {
  ...
  return (
    <div className="animate-fade-in">
      <h2 className="text-2xl font-bold text-blue-800 mb-6 flex items-center gap-2 border-b pb-2">
        <RotateCw className="text-blue-500" /> 認識滑輪
      </h2>
...
function GearSection() {
  ...
  return (
    <div className="animate-fade-in">
      <h2 className="text-2xl font-bold text-blue-800 mb-6 flex items-center gap-2 border-b pb-2">
        <Settings className="text-blue-500" /> 齒輪與鏈條 + 綜合應用
      </h2>
