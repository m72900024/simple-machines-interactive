  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans overflow-x-hidden">
      ...
      <header className="bg-blue-600 text-white p-6 shadow-md sticky top-0 z-50">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center">
          ...
          <nav className="mt-4 md:mt-0 flex flex-wrap gap-2 justify-center">
            ...
            <TabButton active={activeTab === 'lever'} onClick={() => setActiveTab('lever')} label="第1節 槓桿" />
            <TabButton active={activeTab === 'wheel'} onClick={() => setActiveTab('wheel')} label="第2節 輪軸" />
            <TabButton active={activeTab === 'pulley'} onClick={() => setActiveTab('pulley')} label="第3節 滑輪" />
            <TabButton active={activeTab === 'gear'} onClick={() => setActiveTab('gear')} label="第4節 齒輪+綜合" />
      ...
      <main className="max-w-5xl mx-auto p-4 md:p-6 my-4 bg-white rounded-xl shadow-sm border border-slate-200 min-h-[80vh]">
        ...
        {activeTab === 'wheel' && <WheelAxleSection />}
        {activeTab === 'pulley' && <PulleySection />}
